...
+ (instancetype)loadingProgressWithCompletionHandler:(void(^)(NSString * _Nullable state,  NSError * _Nullable error, __nullable AAPLLoadingUpdateBlock update))handler;
